  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">Configurez vos options de livraison</p>
      </div>

      <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
        <Truck className="w-12 h-12 text-gray-300 mx-auto mb-4" />
        <h3 className="text-lg font-medium text-gray-900 mb-1">Configuration des livraisons</h3>
