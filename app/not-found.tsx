        ...
        <Card variant="default" className="p-12 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            <Card variant="teal" className="p-6">
              ...
              <p className="text-sm text-gray-600">Retournez à la page d'accueil</p>
            </Card>
            ...
            <Card variant="pink" className="p-6">
              ...
              <h3 className="font-semibold text-gray-900 mb-1">Produits</h3>
              <p className="text-sm text-gray-600">Découvrez notre catalogue</p>
            </Card>
            ...
            <Card variant="yellow" className="p-6">
              ...
              <h3 className="font-semibold text-gray-900 mb-1">Retour</h3>
              <p className="text-sm text-gray-600">Revenez en arrière</p>
            </Card>
          </div>
