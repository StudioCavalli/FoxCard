...
const marketplacePresets = [
  ...
  },
  {
    name: 'Luxe',
    slug: 'luxe',
    description: 'Raffinement absolu et élégance intemporelle. Palette sophistiquée, détails dorés subtils.',
    config: systemThemes[1].config,
    tags: ['luxe', 'premium', 'élégant', 'bijouterie', 'mode', 'gratuit'],
    isPremium: false,
  },
  {
    name: 'Tech',
    slug: 'tech',
    description: 'Design système moderne et futuriste. Glassmorphism, gradients sophistiqués.',
    config: systemThemes[2].config,
    tags: ['tech', 'moderne', 'sombre', 'startup', 'saas', 'gratuit'],
    isPremium: false,
  },
  {
    name: 'Nature',
